...
const styles = StyleSheet.create((theme) => {
  ...
  return {
    ...
    frontWordRecall: { fontSize: 32, lineHeight: 38 },
    ...
    backWord: { fontFamily: fonts.serif.semibold, fontSize: 40, lineHeight: 44, letterSpacing: -0.8, color: color.textStrong, marginBottom: 8 },
